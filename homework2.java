...
public class homework2 {
    public static void main(String[] args)
    {
       ...
       for(int i=0 ;i<3; i++)
       {
           ...
           //System.out.printf("%d",student[i].Number);
           //Blank = Integer.toString(student[i].Number1);
           //Num = Blank.substring(0,3) + "-" + Blank.substring(3,7) + "-" + Blank.substring(7,10);
           //Num = Blank.substring(0,0);
           System.out.printf("\n");
       }
